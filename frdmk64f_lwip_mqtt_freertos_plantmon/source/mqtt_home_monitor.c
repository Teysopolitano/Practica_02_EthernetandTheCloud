...
static void mqtt_incoming_publish_cb(void *arg, const char *topic, u32_t tot_len)
{
	...
	if (!(strcmp(topic,"Teyson/feeds/soil-moisture")))
		in_topic = MOISTURE;

	else if (!(strcmp(topic,"Teyson/feeds/light")))
		in_topic = LIGHT;

	else if (!(strcmp(topic,"Teyson/feeds/temperature")))
		in_topic = TEMPERATURE;
...
{
    static const char *topics[] = {"Teyson/feeds/soil-moisture", "Teyson/feeds/light", "Teyson/feeds/temperature"};
    int qos[]                   = {1,1,1};
    err_t err;
    int i;
